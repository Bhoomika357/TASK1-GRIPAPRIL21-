...
<body style="background: url(images/et.jpg) no-repeat ; background-size: 1600px 260px; ">
    ...
    <button style="color:green; margin-left:683px; margin-top:20px; " type="button" data-toggle="modal" data-target="#myModal"
        class="login100-form-btn" data-dismiss="modal"><p style="color:white; font-size=15px;">TRANSACTION</p></button>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 style="margin-left: 130px; color: black; font-family:Times new roman;"><b>TRANSACT</b></h4>
                </div>
