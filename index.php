...
.modal-footer>:not(:last-child) {
    ...
    <!-- slider_area_start -->
    <div class="slider_area" style="background-image: url(images/image.jpg);">
                    ...
                    <div class="col-lg-10 col-md-10">
                        <div class="slider_text">
                            <h3 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".1s"
                                style="color:#dc3545; margin-left: -100px;  ">
                                <b style="color: white;">Basic Banking System</b>
                            </h3>
                            <h2 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".1s"
                                style="color: #57b846; margin-left: -100px; margin-top:-35px;">
                                <b style="color:white;">Transferring Money between multiple accounts</b>
                            </h2>
                            <br>
                            <p class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".1s"
                                style="color:white; margin-left: -100px;">
                                <b style="color:white; font-size: 30px;">Managed by the cashier!</b>
                            </p>
                            <br>
                            <a name="getstarted" href="#services" style="margin-left: -100px; width: 50px; "
                                class="login100-form-btn ">
                                <b style="color:white; font-size: 20px;"> Get Started</b>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="section_title text-center mb-70">
                        <span class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s"
                            style="font-size: 50px; color:red; font-family:Times New roma; margin-top: -110px;" id="services"> SERVICES OFFERED</span>
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-4">
                        <div class="single_service text-center wow fadeInLeft" data-wow-duration="1.2s"
                            ...
                            <button type="button" data-toggle="modal" data-target="#myModal">
                                <h3><b style="color:black;">ADD CUSTOMER</b></h3>
                                <p style="color:green;">Add new customers to the list with all the required details and then you are all set
                                    to transact</p>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-md-4">
                        <div class="single_service text-center wow fadeInUp" data-wow-duration="1s"
                            data-wow-delay=".3s">
                            <button type="button" onclick="window.location.href='/Basic-Banking-System/transact.php'">
                                <h3 style="color:blue;"><b style="color:black;">TRANSFER MONEY</b></h3>
                                <p style="color:green;">Transfer money between multiple accounts </p>
                                <br>
                            </button>
                        </div>
...
Modal content-->
                    ...
                    <div class="col-xl-4 col-md-4" >
                        <div class="single_service text-center wow fadeInUp" data-wow-duration="1s"
                            data-wow-delay=".3s">
                            <button type="button" onclick="window.location.href='/Basic-Banking-System/view.php'">
                                <h3 style="color:black;"><b style="color:black;">VIEW CUSTOMERS</b></h3>
                                <p style="color:green">View all the customers having accounts in our bank</p>
                                <br>
                    </button>
                        </div>
...
<h6 class="text-center mt-3"><p style="color: black; font-family:Times new Roman; font-size:14px">Copyright ©2021 All rights reserved  With by Bhoomika M</p>
